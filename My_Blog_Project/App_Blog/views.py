...
class CreateBlog(LoginRequiredMixin,CreateView):
    ...
    def form_valid(self, form):
        ...
        # blog_obj.blog_image = self.request.FILES['blog_image']
...
class BlogList(ListView):
    ...
    model = Blog
    template_name = 'App_Blog/blog_page.html'
...
def blog_details(request, slug):
    ...
    return render(request, 'App_Blog/full_blog.html', context= {'blog':blog, 'comment_form':comment_form, 'liked':liked})
